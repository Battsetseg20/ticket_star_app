...
# Controller responsible for user registrations using Devise gem.
# The create action saves the user based on the provided sign-up parameters,
# creates the associated customer or event organizer instance,
...
module Users
    class RegistrationsController < Devise::RegistrationsController
      ...
      def sign_up_params
        params.require(:user).permit(:email, :password, :password_confirmation, :username, :firstname, :lastname, :birthdate)
      end
